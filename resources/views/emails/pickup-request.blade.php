    ...
    <table width="100%" cellpadding="0" cellspacing="0" 
        ...
        <tr>
            <td style="padding:20px 15px; color:#333; font-size:15px; line-height:1.6;">
                ...
                <p style="margin:0 0 20px;">
                    You have received a new waste pickup request via the company website.
                </p>
                ...
                <table cellpadding="8" cellspacing="0" 
                    ...
                    <tr>
                        <td style="font-weight:bold; color:#1a1f71; vertical-align:top;">Pickup Address:</td>
                        <td>{{ $data['address'] }}</td>
                    </tr>

                    <tr>
                        <td style="font-weight:bold; color:#1a1f71; vertical-align:top;">Waste Type:</td>
                        <td>{{ $data['waste_type'] }}</td>
                    </tr>

                    @if(!empty($data['description']))
                    <tr>
                        <td style="font-weight:bold; color:#1a1f71; vertical-align:top;">Description:</td>
                        <td>{{ $data['description'] }}</td>
                    </tr>
                    @endif

                    <tr>
                        <td style="font-weight:bold; color:#1a1f71; vertical-align:top;">Submitted On:</td>
        ...
        <tr>
            <td style="background:#1a1f71; padding:15px 10px; text-align:center; font-size:12px; color:#ffffff;">
                <div style="font-weight:600; font-size:10px;">All India Waste Management And Transport</div>
